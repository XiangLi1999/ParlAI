...
class TransformerGeneratorMMIAgent(TorchGeneratorAgent):
    ...
    def _compute_posterior(self, inputs, targets, lengths, beam_size):
        """

        inputs: S in P(S|T). Probability of the input given the output.
        ...
        encoder_states = self.model_backwards.encoder(*self._encoder_input(inputs))  # Initialization? Target?
